...
import com.kariyerlink.messageservice.dtos.RoomRequest;
import com.kariyerlink.messageservice.models.Room;
import com.kariyerlink.messageservice.services.RoomService;
...
public class RoomController {
    ...
    public ResponseEntity<java.util.List<Room>> listForUser(@PathVariable String userId){
        return ResponseEntity.ok().body(this.roomService.getRoomsForUser(userId));
    }
}
