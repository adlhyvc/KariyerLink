...
import com.kariyerlink.messageservice.repositories.RoomRepository;
...
public class RoomService {
    ...
    public java.util.List<Room> getRoomsForUser(String userId){
        return this.roomRepository.findBySenderUserIdOrReceiverUserId(userId, userId);
    }
